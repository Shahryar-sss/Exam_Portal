...
@WebServlet("/getPastExams")
public class DisplayPastExams extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DisplayPastExams() {
        super();
    }
					...
					try {
						...
						if (publishDate.compareTo(today) < 0) {
							...
							if (rs2.next()) {
								...
								jb.put("correct", rs2.getString("correct"));
								jb.put("incorrect", rs2.getString("incorrect"));
								jb.put("attempted", rs2.getString("attempted"));
